...
router.post('/cancel-subscription', async (req, res) => {
  try {
    ...
    console.log(`🔄 Iniciando cancelamento de assinatura para usuário ${user.id}`);
    ...
    console.log(`📝 Assinatura encontrada: ${subscription.subscription_id}`);
    ...
    console.log(`✅ Assinatura marcada para cancelamento no Stripe`);
