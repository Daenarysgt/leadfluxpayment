  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 pt-3 px-4 md:px-6">
      <div className="flex items-center justify-between gap-2 md:gap-4">
        {/* Bloco 1: Logo */}
        <div className="bg-white rounded-xl shadow-[0_2px_10px_rgba(0,0,0,0.08)] p-2">
        ...
        <nav className="hidden lg:block flex-grow">
          <div className="bg-white rounded-xl shadow-[0_2px_10px_rgba(0,0,0,0.08)] px-6">
            <ul className="flex items-center justify-center h-12">
              {navLinks.map((link, index) => (
                <li key={index} className="relative group mx-2">
                  ...
                  {link.dropdown && (
                    <div className="absolute left-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-2 z-10 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
        ...
        <div className="hidden md:block">
          <div className="bg-white rounded-xl shadow-[0_2px_10px_rgba(0,0,0,0.08)]">
            <a 
              href="#contact" 
        ...
        <div className="flex items-center gap-2 bg-white rounded-xl shadow-[0_2px_10px_rgba(0,0,0,0.08)] p-1.5">
          <a 
            href="/login" 
          ...
          <a 
            href="/signup" 
            className="bg-gradient-to-r from-blue-600 to-violet-600 text-white font-medium text-sm py-2 px-4 rounded-lg transition-all duration-200 hover:shadow-md"
          >
            Cadastre-se
          </a>
        </div>
        ...
        {/* Botão Mobile Menu */}
        <button 
          className="lg:hidden bg-white p-2 rounded-lg shadow-sm"
      ...
      {/* Menu Mobile */}
      {isOpen && (
        <div className="lg:hidden mt-2 bg-white rounded-xl shadow-lg p-4">
